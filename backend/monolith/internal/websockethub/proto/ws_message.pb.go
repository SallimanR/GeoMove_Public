...
func (x *SubscribeMessage) GetIndexes() []uint32 {
	if x != nil {
		return x.Indexes
	}
	return nil
...
func (x *UnsubscribeMessage) GetIndexes() []uint32 {
	if x != nil {
		return x.Indexes
	}
	return nil
...
const file_ws_message_proto_rawDesc = "" +
	...
	"\aindexes\x18\x01 \x03(\rR\aindexes\".\n" +
	"\x12UnsubscribeMessage\x12\x18\n" +
	"\aindexes\x18\x01 \x03(\rR\aindexes\"\x8c\x01\n" +
	"\bResponse\x128\n" +
