...
Приложения для Android: **[перейти на страницу для скачивания](https://github.com/SallimanR/GeoMove_Public/releases/tag/pre-release_3)** -> скачать apk приложения для пользователей/водителей -> найти apk в загрузках браузера или в папке Downloads -> запустить apk
